...
ZL_CORE_DIR_PATHS = $(patsubst %, src/zlibrary/core/src/%, $(ZL_CORE_DIRS))
...
ZL_CORE_DIR_PATHS_EXTRA = $(patsubst %, src/zlibrary/core/src/%, $(ZL_CORE_DIRS_EXTRA))

ZL_TEXT_DIRS = fonts model json
ZL_TEXT_DIR_PATHS = $(patsubst %, src/zlibrary/text/src/%, $(ZL_TEXT_DIRS))
ZL_TEXT_INCLUDE = $(ZL_CORE_INCLUDE) $(patsubst %, -I $(ROOTDIR)/%, $(ZL_TEXT_DIR_PATHS))

FBREADER_DIRS = bookmodel formats library
FBREADER_DIR_PATHS = $(patsubst %, src/fbreader/src/%, $(FBREADER_DIRS))
...
FORMAT_DIR_PATHS = $(patsubst %, src/fbreader/src/formats/%, $(FORMAT_DIRS))
